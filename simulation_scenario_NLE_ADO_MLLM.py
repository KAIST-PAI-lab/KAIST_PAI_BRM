# Simulation scenario: run NLE with ADO, given MLLM
...
print(f"Selected Model: {cognitive_model_name}")

cognitive_model = getattr(psy_funcs, cognitive_model_name)
...
for i in range(N_TRIALS):
    ...
    response = cognitive_model_simulate_response(
...
plt.plot(
    ...
    cognitive_model(**true_params, given_number=np.linspace(0, N_MAX, N_MAX)),
    color="red",
)
plt.show()
