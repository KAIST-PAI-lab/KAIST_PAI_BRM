...
from gpal.gpal_optimize import gpal_optimize, KernelInstance
...
def run_NLE_block(num_trials, size_control=False):
    """
    ...
    for i in range(num_trials):
        ...
        if i==0:
            ...
            number, max_number=gpal_optimize()
...
def run_experiment():
    ...
    parser.add_argument('--alpha', type=Union[float, ], default=1e-10, help='')
